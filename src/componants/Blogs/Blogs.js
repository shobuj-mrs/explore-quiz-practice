...
const Blogs = () => {
    return (
        <div className=' py-6 w-11/12 mx-auto'>
            <div className='border-2 shadow-xl mb-6 rounded-lg'>
                <h1 className='text-4xl font-semibold text-center my-4 text-teal-600'> What is the purpose of React Router?</h1>
            ...
            <div className='border-2 shadow-xl mb-6 rounded-lg'>
                <h1 className='text-4xl font-semibold text-center my-4 text-teal-600'>How does Context API works?</h1>
            ...
            <div className='border-2 shadow-xl mb-6 rounded-lg'>
                <h1 className='text-4xl font-semibold text-center my-4 text-teal-600'>What is the useRef hook in reactjs?</h1>
